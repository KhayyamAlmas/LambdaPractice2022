...
public class C2_StringList_StreamOrnekleri {
    public static void main(String[] args) {
        ...
        lLeriSil(list);
        System.out.println("eOlanlardanYeniList(list) = " + eOlanlardanYeniList(list));
    ...
    public static void lLeriSil(List<String>l) {
        System.out.println();
        l.stream().map(t -> t.replaceAll("l", "")).forEach(t -> System.out.print(t + " "));
    }

    // S5: icinde e olanlardan yeni bir list olusturunuz
    public static List<String> eOlanlardanYeniList(List<String>l) {
        System.out.println();
    ...
    public static void ilkHarfi3KereYaz(List<String>l){
        System.out.println();
        l.stream().
                map(t -> t.substring(0,1).toLowerCase()+t.substring(0,1).toLowerCase()+t.toLowerCase()).
